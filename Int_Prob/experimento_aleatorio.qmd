...
![Diagramas de Venn (@degroot2012probability)](figs/venn.png)

### Leis de DeMorgan

As [Leis de DeMorgan](https://en.wikipedia.org/wiki/De_Morgan%27s_laws) são teoremas fundamentais que descrevem relações entre a união e interesecção entre conjuntos e de seus complementos.
...
Portanto: A negação de "Está chovendo e está frio" ($A \cap B$) é "Não está chovendo ou não está frio" ($A^c \cup B^c$);
